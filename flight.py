...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(
                      ...
                      ' they will be created running SExtractor. Coordinates'
                      ' should be given in FITS format.')

    parser.add_argument('image',type=str,help='FITS file for analysis')
    parser.add_argument('loc',type=str,help='image pixel coordinates '
    ...
    parser.add_argument('-s','--segmap',type=str,default=None,help='name of '
                        ...
                        'None)')
    parser.add_argument('-m','--segsect',type=str,default='t',help='method of'
